          ...
          <div className="mb-3 mt-4">
            ...
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center space-x-3">
                <h1 className={`text-lg sm:text-xl font-semibold ${mode === 'dark' ? 'text-white' : 'text-gray-900'}`}>
                  Men's Collection
                </h1>
          ...
          <div className="flex flex-col lg:flex-row gap-3">
            ...
            <div className="hidden lg:block lg:w-72 flex-shrink-0">
              <div className={`${mode === 'dark' ? 'bg-gray-800' : 'bg-white'} rounded-xl p-3 shadow-sm border ${mode === 'dark' ? 'border-gray-700' : 'border-gray-200'} sticky top-8`}>
                ...
                {/* Search Bar */}
                <div className="mb-3">
                  <label className={`block text-sm font-medium mb-2 ${mode === 'dark' ? 'text-white' : 'text-gray-900'}`}>
                    Search Products
                  </label>
            ...
            <div className="flex-1">
              ...
              {showFilters && (
                <div className="lg:hidden mb-3">
                  <div className={`${mode === 'dark' ? 'bg-gray-800' : 'bg-white'} rounded-xl p-3 shadow-sm border ${mode === 'dark' ? 'border-gray-700' : 'border-gray-200'}`}>
