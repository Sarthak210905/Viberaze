...
import { FaHeart, FaShoppingCart, FaFilter, FaBars, FaTimes } from 'react-icons/fa'
  ...
  return (
    <Layout>
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Mobile Category and Filter Menu */}
        {mobileMenuOpen && (
          <div className="lg:hidden mb-6 bg-white shadow-lg rounded-lg p-4">
            <div className="flex flex-col space-y-4">
              ...
              <div className="flex flex-col space-y-2">
                ...
                {/* Mobile Search and Price Filter */}
                <input 
                  type="text" 
        ...
        {/* Desktop Filters */}
        {showFilters && (
          <div className="hidden lg:block mb-8 p-4 bg-gray-100 rounded-lg">
